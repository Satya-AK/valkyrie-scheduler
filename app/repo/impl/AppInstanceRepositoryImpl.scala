...
import repo.{AppInstanceLogRepository, AppInstanceRepository, AppStatusRepository}
...
@Singleton()
class AppInstanceRepositoryImpl @Inject()(protected val dbConfigProvider: DatabaseConfigProvider,
 ...
 extends AppInstanceRepository  with HasDatabaseConfigProvider[JdbcProfile] {

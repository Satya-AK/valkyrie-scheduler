...
import model.quartz.SchedulerTrigger
...
class TriggerTable @Inject()(protected val dbConfigProvider: DatabaseConfigProvider)
  ...
  class TableDef(tag: Tag) extends Table[SchedulerTrigger](tag, "QRTZ_JOB_DETAILS") {
    ...
    override def * = (triggerName, groupName, jobName, jobGroup, description, nextFireTime, previousFireTime) <> (SchedulerTrigger.tupled, SchedulerTrigger.unapply)
  }

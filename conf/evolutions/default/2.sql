...
create table "APP_INSTANCE" ("INSTANCE_ID" varchar(40) NOT NULL,"GROUP_ID" varchar(100) NOT NULL,"JOB_ID" varchar(100) NOT NULL,"TRIGGER_ID" VARCHAR(100),"START_TIME" TIMESTAMP NOT NULL,"END_TIME" TIMESTAMP,"MESSAGE" VARCHAR(200),"RETURN_CODE" INTEGER,"SEQ_ID" BIGINT NOT NULL,"STATUS_ID" INTEGER NOT NULL,"ATTEMPT" INTEGER NOT NULL,"AGENT_NAME" varchar(100) NOT NULL);
